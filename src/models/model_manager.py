...
class ModelManager:
    ...
    def _load_model(self) -> None:
        ...
        if os.path.exists(checkpoint_path):
            ...
            try:
                logger.info(f"Downloading model from HuggingFace: {self.config.model.huggingface_repo_id}")
    ...
    def batch_transcribe_files(self, audio_paths: list[Union[str, Path]]) -> list[str]:
        """
