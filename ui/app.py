...
# Function to check API connection and fallback to host machine if needed
def get_api_url():
    """
    ...
    st.error(f"❌ Could not establish API connection. Using {API_URL} but functionality may be limited.")
    return API_URL
