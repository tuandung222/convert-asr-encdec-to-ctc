...
def test_model_with_samples(
    ...
    samples_dir="examples/viet_samples",
    device="cpu"
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="tuandunghcmut/PhoWhisper-tiny-CTC", help="Model ID or path")
    parser.add_argument("--samples", default="examples/viet_samples", help="Directory with test samples")
